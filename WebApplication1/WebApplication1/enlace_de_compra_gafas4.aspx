<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="enlace_de_compra_gafas4.aspx.cs" Inherits="WebApplication1.enlace_de_compra_gafas4" %>
<!DOCTYPE html>
<html lang="es">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="glasses_box">
                        <a href="enlace_de_compra_gafas4.html">
                            <figure><img src="images/glass4.png" alt="#" /></figure>
                            <h3><span class="blu">$</span>120.000</h3>
                            <p>Gafas de Sol</p>
                            <p class="text-center">Con un toque de vanguardia, las gafas "Moda Urbana" son ideales para
                                aquellos que buscan destacar en la jungla urbana. Con monturas modernas y detalles de
                                alta costura, estas gafas transformarán tus outfits cotidianos en declaraciones de
                                estilo.</p>
                        </a>
                        <a href="enlace_de_compra_gafas4.html" class="btn btn-primary">Agregar al Carrito</a>
                    </div>
                </div>
                <div class="col-md-6">
                        ...
                        <div class="talla_carrito">
                            ...
                            <div>
                                ...
                                <button class="boton-agregar"
                                    onclick="agregarAlCarrito(1, 'Gafas de Sol', 120000)">Agregar al carrito</button>
                            </div>
