<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="enlace_de_compra_gafas2.aspx.cs" Inherits="WebApplication1.enlace_de_compra_gafas2" %>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="glasses_box">
                        <a href="enlace_de_compra_gafas2.html">
                            <figure><img src="images/glass2.png" alt="#" /></figure>
                            <h3><span class="blu">$</span>200.000</h3>
                            <p>Gafas de Sol</p>
                            <p class="text-center">Diseñadas para acompañarte en todas tus aventuras, las gafas
                                "Aventura Activa" son resistentes, ligeras y cuentan con lentes irrompibles. Ya sea en
                                la montaña o en la playa, estas gafas te ofrecen estilo y protección en cada paso.</p>
                        </a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="right-sidebar">
                        ...
                        <div>
                            ...
                            <button class="boton-agregar" onclick="agregarAlCarrito(1, 'Gafas de Sol', 200000)">Agregar
                                al carrito</button>
                        </div>
                    </div>
