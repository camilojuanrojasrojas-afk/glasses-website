<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="enlace_de_compra_gafas5.aspx.cs" Inherits="WebApplication1.enlace_de_compra_gafas5" %>
                                ...
                                <div class="carrito-container">
                                    <div>
                                        <img class="carrito" src="images/carrito1.jpg" alt="#"
                                            style="width: 50px; height: 50px;" onclick="abrirModal()">
                                        <div id="numero">0</div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="glasses_box">
                        <a href="enlace_de_compra_gafas5.html">
                            <figure><img src="images/glass5.png" alt="#" /></figure>
                            <h3><span class="blu">$</span>94.000</h3>
                            <p>Gafas de Sol</p>
                            <p class="text-center">Viaja en el tiempo con nuestras gafas "Estilo Retro". Inspiradas en
                                la moda clásica, estas gafas combinan el encanto vintage con la tecnología moderna. Un
                                accesorio imprescindible para quienes buscan un toque nostálgico con un giro
                                contemporáneo.</p>
                        </a>
                    </div>
                </div>
                        ...
                        <div class="talla_carrito">
                            ...
                            <div>
                                ...
                                <button class="boton-agregar"
                                    onclick="agregarAlCarrito(1, 'Gafas de Sol', 94000)">Agregar al carrito</button>
                            </div>
