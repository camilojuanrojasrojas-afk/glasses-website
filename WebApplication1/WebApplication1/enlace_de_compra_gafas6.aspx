<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="enlace_de_compra_gafas6.aspx.cs" Inherits="WebApplication1.enlace_de_compra_gafas6" %>
<!DOCTYPE html>
<html lang="es">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="glasses_box">
                        <a href="enlace_de_compra_gafas6.html">
                            <figure><img src="images/glass6.png" alt="#" /></figure>
                            <h3><span class="blu">$</span>60.000</h3>
                            <p>Gafas de Sol</p>
                            <p class="text-center">Para las noches estrelladas y los eventos especiales, las gafas
                                "Elegancia Nocturna" son la elección perfecta. Con lentes ahumados y monturas
                                glamorosas, estas gafas aportan un toque de misterio y sofisticación a cualquier
                                ocasión.</p>
                        </a>
                    </div>
                </div>
                        ...
                        <div class="talla_carrito">
                            ...
                            <div>
                                ...
                                <button class="boton-agregar"
                                    onclick="agregarAlCarrito(1, 'Gafas de Sol', 60000)">Agregar al carrito</button>
                            </div>
