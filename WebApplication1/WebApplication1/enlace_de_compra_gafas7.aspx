<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="enlace_de_compra_gafas7.aspx.cs" Inherits="WebApplication1.enlace_de_compra_gafas7" %>
<!DOCTYPE html>
<html lang="es">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="glasses_box">
                        <a href="enlace_de_compra_gafas7.html">
                            <figure><img src="images/glass7.png" alt="#" /></figure>
                            <h3><span class="blu">$</span>80.350</h3>
                            <p>Gafas de Sol</p>
                            <p class="text-center">Menos es más con nuestras gafas "Minimalismo Moderno". Diseñadas con
                                líneas limpias y colores sutiles, estas gafas son la opción perfecta para quienes buscan
                                un estilo discreto pero sofisticado. La elegancia en su forma más pura.</p>
                        </a>
                    </div>
                </div>
                <div class="col-md-6">
                        ...
                        <div class="talla_carrito">
                            ...
                            <div>
                                ...
                                <button class="boton-agregar"
                                    onclick="agregarAlCarrito(1, 'Gafas de Sol', 80350)">Agregar al carrito</button>
                            </div>
