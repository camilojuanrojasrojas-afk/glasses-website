<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="programa8.aspx.cs" Inherits="WebApplication1.programa8" %>
...
<head>
   ...
   <title>Proceso de Producción de Huevos</title>
...
<body class="main-layout position_head">
   ...
   <!-- Contenido principal - Proceso de Producción de Huevos -->
   <div class="container mt-5 calculator-block">
      <h2>Proceso de Producción de Huevos</h2>
      <div class="calculator-form">
         <label for="num-gallinas">Ingrese el número de gallinas:</label>
         <input type="number" id="num-gallinas" min="0">
         <label for="num-dias">Ingrese el número de días:</label>
         <input type="number" id="num-dias" min="0">
         <button onclick="calcularProduccion()">Calcular</button>
         <p class="calculator-result" id="produccion-huevos">Producción de Huevos: 0</p>
      </div>
   </div>
   ...
   <script>
      function calcularProduccion() {
         const numGallinas = parseInt(document.getElementById('num-gallinas').value);
         const numDias = parseInt(document.getElementById('num-dias').value);
   
         const produccion = 0.75 * numGallinas * numDias;
   
         document.getElementById('produccion-huevos').textContent = "Producción de Huevos: " + produccion;
      }
   </script>
</body>
</html>
