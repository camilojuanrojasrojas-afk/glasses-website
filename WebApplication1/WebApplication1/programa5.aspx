<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="programa5.aspx.cs" Inherits="WebApplication1.programa5" %>
...
<body class="main-layout position_head">
   ...
   <div class="container mt-5 calculator-block">
      ...
      <div class="calculator-form">
         ...
         <input type="number" id="max-temp">
         <label for="min-temp">Temperatura Mínima:</label>
         <input type="number" id="min-temp">
         <button onclick="agregarTemperatura()">Agregar Temperatura</button>
   ...
   <script>
      ...
      function agregarTemperatura() {
         ...
         document.getElementById('num-dias').textContent = numDias;
         document.getElementById('media-maxima').textContent = (sumaMaxima / numDias).toFixed(2);
         document.getElementById('media-minima').textContent = (sumaMinima / numDias).toFixed(2);
         document.getElementById('num-errores').textContent = numErrores;
         document.getElementById('porcentaje-errores').textContent = ((numErrores / numDias) * 100).toFixed(2);
      }
   </script>
</body>
</html>
